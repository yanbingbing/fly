...
class Uri
{
	...
	public function __construct($uri = null)
	{
		if (is_string($uri)) {
			...
			throw new Exception\InvalidArgumentException(sprintf('Expecting a string or a URI object, received "%s"',
	...
	public static function encodeUserInfo($userInfo)
	{
		if (!is_string($userInfo)) {
			throw new Exception\InvalidArgumentException(sprintf('Expecting a string, got %s',
	...
	{
		$path = self::encodePath(self::decodeUrlEncodedChars(self::removePathDotSegments($path),
	...
	{
		$query = self::encodeQueryFragment(self::decodeUrlEncodedChars($query,
